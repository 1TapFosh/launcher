...
cp native/build-x64/src/Release/RuneFusion.exe build/win-x64/
cp target/RuneFusion.jar build/win-x64/
...
echo RuneFusion.exe 64bit sha256sum
sha256sum build/win-x64/RuneFusion.exe

dumpbin //HEADERS build/win-x64/RuneFusion.exe
