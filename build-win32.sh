...
cp native/build-x86/src/Release/RuneFusion.exe build/win-x86/
cp target/RuneFusion.jar build/win-x86/
...
echo RuneFusion.exe 32bit sha256sum
sha256sum build/win-x86/RuneFusion.exe

dumpbin //HEADERS build/win-x86/RuneFusion.exe
