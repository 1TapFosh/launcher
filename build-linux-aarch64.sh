...
chmod 644 target/RuneFusion.jar

cp native/build-aarch64/src/RuneFusion build/linux-aarch64/
cp target/RuneFusion.jar build/linux-aarch64/
...
ln -s RuneFusion AppRun

# Ensure RuneLite is executable to all users
chmod 755 RuneFusion
popd
