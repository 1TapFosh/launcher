...
cp native/build-aarch64/src/Release/RuneFusion.exe build/win-aarch64/
cp target/RuneFusion.jar build/win-aarch64/
...
echo RuneFusion.exe aarch64 sha256sum
sha256sum build/win-aarch64/RuneFusion.exe

dumpbin //HEADERS build/win-aarch64/RuneFusion.exe
